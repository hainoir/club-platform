            ...
            <DialogContent className="sm:max-w-[425px]">
                <form onSubmit={onSave}>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {editingMember ? "在这里修改该成员的详细信息。" : "输入新成员信息并分配访问权限。"}
                        </DialogDescription>
                    </DialogHeader>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="grid gap-2">
                                ...
                                <select
                                    id="role"
                                    name="role"
                                    defaultValue={editingMember?.role || "干事"}
                            ...
                            <div className="grid gap-2">
                                ...
                                <select
                                    id="department"
                                    name="department"
                                    defaultValue={editingMember?.department || "未分配"}
                                    className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background outline-none focus:ring-2 focus:ring-ring"
                                >
                            ...
                            <div className="grid gap-2">
                                ...
                                <select
                                    id="grade"
                                    name="grade"
                                    defaultValue={editingMember?.grade || ""}
                                    className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background outline-none focus:ring-2 focus:ring-ring"
                                >
                    ...
                    <DialogFooter>
                        ...
                        <Button type="submit" disabled={isSubmitting}>
                            {isSubmitting ? "保存中..." : editingMember ? "保存修改" : "创建成员"}
                        </Button>
                    </DialogFooter>
                </form>
            </DialogContent>
